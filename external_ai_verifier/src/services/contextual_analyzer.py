...
class ExternalContextualAnalyzer:
    ...
    def _extract_temporal_markers(self, text: str) -> List[str]:
        ...
        temporal_patterns = [
            ...
            r'(?:2019|2020|2021|2022|2023|2025|2025)',
    ...
    def _check_item_temporal_consistency(self, markers: List[str], item_time: str) -> float:
        ...
        try:
            ...
            # Check if markers mention old years (before last year)
            # Corrige a ordem da comprehension para evitar UnboundLocalError
            mentions_old_years = any(str(year) in m for m in markers for year in range(2015, current_year - 1))
